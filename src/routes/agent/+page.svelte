...
<div class="flex flex-col w-full items-center justify-center">
  {#if data && !data.agents.length}
    ...
    <h1 class="text-white select-none">Where are your agents?</h1>
    <p class="text-gray-400 select-none pointer-events-none">
      Let's <a class="pointer-events-auto" href="/agent/create">add</a> your favorite
      agent!
    </p>
  {/if}
</div>
